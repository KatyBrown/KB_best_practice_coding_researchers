...
**Whole Group Discussion** When you are trying to understand a piece of code, what do you find makes it easier or more difficult?

*make a list based on suggestions*

**Small Group Activity**: The following two code snippets produce the same output. What features of the second snippet make it more readable than the first?
...
**Whole Group Discussion**: Put the following in order of importance
